...
function TabConfig({S,config,setConfig,saveConfig,cfgTab,setCfgTab,newTipo,setNewTipo,newDis,setNewDis,showNewT,setShowNewT,showNewD,setShowNewD,showToast}){
  ...
  const tabs=["📦 Tipos de trabajo","📐 Áreas",<span style={{display:"flex",alignItems:"center",gap:4}}><svg width="16" height="16" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" style={{display:"inline-block",verticalAlign:"middle",marginRight:5}}><circle cx="50" cy="50" r="20" fill="url(#vg2)"/><defs><linearGradient id="vg2" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#64B5F6"/><stop offset="100%" stopColor="#4A6FD4"/></linearGradient></defs><circle cx="50" cy="42" r="8" fill="#E8EEF8"/><ellipse cx="50" cy="58" rx="10" ry="7" fill="#E8EEF8"/><circle cx="50" cy="8" r="8" fill="#64B5F6"/><circle cx="50" cy="92" r="8" fill="#64B5F6"/><circle cx="12" cy="50" r="8" fill="#64B5F6"/><circle cx="88" cy="50" r="8" fill="#64B5F6"/><circle cx="24" cy="24" r="7" fill="#90CAF9"/><circle cx="76" cy="24" r="7" fill="#90CAF9"/><circle cx="24" cy="76" r="7" fill="#90CAF9"/><circle cx="76" cy="76" r="7" fill="#90CAF9"/><line x1="50" y1="30" x2="50" y2="16" stroke="#B0C4DE" strokeWidth="2.5"/><line x1="50" y1="70" x2="50" y2="84" stroke="#B0C4DE" strokeWidth="2.5"/><line x1="30" y1="50" x2="18" y2="50" stroke="#B0C4DE" strokeWidth="2.5"/><line x1="70" y1="50" x2="82" y2="50" stroke="#B0C4DE" strokeWidth="2.5"/><line x1="36" y1="36" x2="28" y2="28" stroke="#B0C4DE" strokeWidth="2.5"/><line x1="64" y1="36" x2="72" y2="28" stroke="#B0C4DE" strokeWidth="2.5"/><line x1="36" y1="64" x2="28" y2="72" stroke="#B0C4DE" strokeWidth="2.5"/><line x1="64" y1="64" x2="72" y2="72" stroke="#B0C4DE" strokeWidth="2.5"/></svg>Usuarios</span>];
  const tipos=config.tipos||[];
  const dis=config.disenadores||[];
  const areas=config.areas||AREAS_DEFAULT;
